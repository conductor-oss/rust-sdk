...
impl WorkflowTask {
    ...
    pub fn http(task_ref_name: impl Into<String>, uri: impl Into<String>) -> Self {
        ...
        input.insert("http_request".to_owned(), http_request);
    ...
    pub fn inline(task_ref_name: impl Into<String>, script: impl Into<String>) -> Self {
        ...
        input.insert(
            "evaluatorType".to_owned(),
            serde_json::Value::String("graaljs".to_owned()),
        );
    ...
    pub fn switch(task_ref_name: impl Into<String>, case_expression: impl Into<String>) -> Self {
        Self {
            ...
            evaluator_type: Some("javascript".to_owned()),
            ..Default::default()
        }
    }
    ...
    pub fn switch_value_param(
        ...
        Self {
            ...
            task_type: TaskType::Switch,
            expression: Some(case_expression.into()),
            evaluator_type: Some("value-param".to_owned()),
            ..Default::default()
        }
    }
    ...
    pub fn json_jq_transform(task_ref_name: impl Into<String>, query: impl Into<String>) -> Self {
        let mut input = HashMap::new();
        input.insert(
            "queryExpression".to_owned(),
            serde_json::Value::String(query.into()),
        );

        Self {
            name: "json_jq_transform".to_owned(),
            task_reference_name: task_ref_name.into(),
    ...
    pub fn wait_for_webhook(task_ref_name: impl Into<String>) -> Self {
        Self {
            name: "wait_for_webhook".to_owned(),
            task_reference_name: task_ref_name.into(),
    ...
    pub fn with_matches(mut self, matches: HashMap<String, String>) -> Self {
        ...
        self.input_parameters
            .insert("matches".to_owned(), serde_json::json!(matches_value));
        self
    }
    ...
    pub fn llm_text_complete(
        ...
        Self {
            name: "llm_text_complete".to_owned(),
            task_reference_name: task_ref_name.into(),
    ...
    pub fn llm_chat_complete(
        ...
        input.insert("model".to_owned(), serde_json::json!(model.into()));
        input.insert("messages".to_owned(), serde_json::json!([]));

        Self {
            name: "llm_chat_complete".to_owned(),
            task_reference_name: task_ref_name.into(),
    ...
    pub fn with_temperature(mut self, temp: f32) -> Self {
        self.input_parameters
            .insert("temperature".to_owned(), serde_json::json!(temp));
        self
    }
    ...
    pub fn with_max_tokens(mut self, tokens: i32) -> Self {
        self.input_parameters
            .insert("maxTokens".to_owned(), serde_json::json!(tokens));
        self
    }
    ...
    pub fn with_top_p(mut self, top_p: f32) -> Self {
        self.input_parameters
            .insert("topP".to_owned(), serde_json::json!(top_p));
        self
    }
    ...
    pub fn with_prompt_variables(mut self, variables: HashMap<String, serde_json::Value>) -> Self {
        self.input_parameters
            .insert("promptVariables".to_owned(), serde_json::json!(variables));
        self
    }
    ...
    pub fn with_prompt_variable(
        ...
        let vars = self
            .input_parameters
            .entry("promptVariables".to_owned())
    ...
    pub fn llm_generate_embeddings(
        ...
        input.insert("model".to_owned(), serde_json::json!(model.into()));
        input.insert("text".to_owned(), serde_json::json!(text.into()));

        Self {
            name: "llm_generate_embeddings".to_owned(),
            task_reference_name: task_ref_name.into(),
    ...
    pub fn llm_search_index(
        ...
        input.insert("query".to_owned(), serde_json::json!(query.into()));

        Self {
            name: "llm_search_index".to_owned(),
            task_reference_name: task_ref_name.into(),
    ...
    pub fn with_namespace(mut self, namespace: impl Into<String>) -> Self {
        self.input_parameters
            .insert("namespace".to_owned(), serde_json::json!(namespace.into()));
        self
    }
    ...
    pub fn with_max_results(mut self, max: i32) -> Self {
        self.input_parameters
            .insert("maxResults".to_owned(), serde_json::json!(max));
        self
    }
    ...
    pub fn llm_index_text(
        ...
        input.insert("index".to_owned(), serde_json::json!(index.into()));
        input.insert("text".to_owned(), serde_json::json!(text.into()));
        input.insert("docId".to_owned(), serde_json::json!(doc_id.into()));

        Self {
            name: "llm_index_text".to_owned(),
            task_reference_name: task_ref_name.into(),
    ...
    pub fn llm_index_document(
        ...
        input.insert("vectorDB".to_owned(), serde_json::json!(vector_db.into()));
        input.insert("index".to_owned(), serde_json::json!(index.into()));
        input.insert("url".to_owned(), serde_json::json!(url.into()));
        input.insert("docId".to_owned(), serde_json::json!(doc_id.into()));

        Self {
            name: "llm_index_document".to_owned(),
            task_reference_name: task_ref_name.into(),
    ...
    pub fn with_media_type(mut self, media_type: impl Into<String>) -> Self {
        self.input_parameters
            .insert("mediaType".to_owned(), serde_json::json!(media_type.into()));
        self
    }
    ...
    pub fn with_metadata(mut self, metadata: HashMap<String, String>) -> Self {
        self.input_parameters
            .insert("metadata".to_owned(), serde_json::json!(metadata));
        self
    }
    ...
    pub fn dynamic(task_ref_name: impl Into<String>, dynamic_task_name: impl Into<String>) -> Self {
        ...
        Self {
            ...
            input_parameters: input,
            dynamic_task_name_param: Some("dynamicTaskName".to_owned()),
            ..Default::default()
        }
    }
...
mod tests {
    ...
    fn test_workflow_def_builder() {
        ...
        assert_eq!(wf.description, Some("Test workflow".to_owned()));
    ...
    fn test_list_mcp_tools_task_builder() {
        ...
        assert_eq!(
            ...
            Some(&serde_json::Value::String(
                "http://localhost:3001/mcp".to_owned()
            ))
        );
